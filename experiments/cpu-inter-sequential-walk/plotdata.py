...
file1=outdir+'nozc-no-seqwalk.json'
file2=outdir+'nozc-rnd-seqwalk.json'
file3=outdir+'nozc-seq-seqwalk.json'
file4=outdir+'zc-no-seqwalk.json' 
file5=outdir+'zc-rnd-seqwalk.json'
file6=outdir+'zc-seq-seqwalk.json'
...
plt.title('Sequential walk on increasing data set with different CPU interference on TX2\n')
