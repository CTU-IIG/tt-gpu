...
filename1 = "out-seq/512-cg-kernels-1thread-same-elem.json"
filename2 = "out-seq/512-cg-kernels-32thread-same-elem.json"
filename3 = "out-seq/512-cg-kernels-128thread-same-elem.json"
filename4 = "out-seq/256-cg-kernels-1thread-same-elem.json"
filename5 = "out-seq/256-cg-kernels-32thread-same-elem.json"
filename6 = "out-seq/256-cg-kernels-128thread-same-elem.json"
filename7 = "out-seq/128-cg-kernels-1thread-same-elem.json"
filename8 = "out-seq/128-cg-kernels-32thread-same-elem.json"
filename9 = "out-seq/128-cg-kernels-128thread-same-elem.json"
...
plt.xlim([0.5,16.5])
plt.ylabel('Slowdown')
fig.savefig('seq-walk-mult-kernel-seqint.pdf', format='pdf',bbox_inches='tight')
plt.show()
