...
filename1 = "out-nointer/512-cg-kernels-1thread-same-elem.json"
filename2 = "out-nointer/512-cg-kernels-32thread-same-elem.json"
filename3 = "out-nointer/512-cg-kernels-128thread-same-elem.json"
filename4 = "out-nointer/256-cg-kernels-1thread-same-elem.json"
filename5 = "out-nointer/256-cg-kernels-32thread-same-elem.json"
filename6 = "out-nointer/256-cg-kernels-128thread-same-elem.json"
filename7 = "out-nointer/128-cg-kernels-1thread-same-elem.json"
filename8 = "out-nointer/128-cg-kernels-32thread-same-elem.json"
filename9 = "out-nointer/128-cg-kernels-128thread-same-elem.json"
