...
def assignBlocksToSM(nofKernel, nofBlocks, nofThreads, blockTimes, smids):
    agg_sm = {}
...
def drawScenario(agg_sm, nofKernel, minTime, maxTime):
    fig = plt.figure()
...
agg_sm = assignBlocksToSM(nofKernel, nofBlocks, nofThreads, blockTimes, smids)
adjustThreadOffset(agg_sm)
drawScenario(agg_sm, nofKernel, minTime, maxTime)
